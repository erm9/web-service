 ...
 * @author Ermiaas Mengisteab
 * @version 1.01 2015/02/15
 * @link https://github.com/erm9/web-service	
...
{//check to be sure data has been transmitted via GET or POST
	...
	{//determine contents of 'cat'
		case "box":
			include('data/Transformers-box-office.js'); //"box" orders by box office results
			break;
		default:
			include('data/Transformers-year.js'); //default orders by year
	}
