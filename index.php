<html>
<head>
<title>Transformers Web Service Demo</title>
<style>
...
$(document).ready(function() {  
	...
	<body>
	<h1>Transformers Web Service</h1>
		<a href="year" class="category"> Transformers By Year</a><br />
		<a href="box" class="category">Transformers By Box Office</a>
